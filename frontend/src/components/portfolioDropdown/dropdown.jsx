...
const DropDown = () => {
	// Contexts
	const { portfolioFilter, setPortfolioFilter, portfolioList, updatePortfolioList } =
		usePortfolio();
	...
	return (
		<div id="dropdown-container">
			...
			>
				...
				<option className="select-footer" value="createNew">
					Create New
				</option>
			</select>
					...
					<div className="modal-content">
						...
						<form onSubmit={handleNewPortfolio}>
							<div className="modal-body">
								<div className="mb-3">
									<label htmlFor="portfolioName" className="col-form-label">
										Portfolio Name
									</label>
									<input
										required
							...
							<div className="modal-footer">
								...
								<button type="submit" className="btn" id="create">
									Create
								</button>
							</div>
						</form>
