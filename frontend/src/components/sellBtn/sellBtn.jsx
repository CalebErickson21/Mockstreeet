...
const SellBtn = ({ stock, company }) => {
	...
	return (
		<>
			<button onClick={() => setShowSell(true)} className="btn btn-dark-blue">
				Sell
			</button>
			...
			<div
				id="buy-modal"
				className={`modal fade ${showSell ? "show d-block" : ""}`}
					...
					<div className="modal-content">
						...
						<form onSubmit={handleSell}>
							<div className="modal-body">
								<label htmlFor="sellShares" className="col-form-label">
									Sell {stock} Shares
								</label>
								<input
									required
							...
							<div className="modal-footer">
								...
								<button type="submit" className="btn" id="buyBtn">
									Sell
								</button>
							</div>
						</form>
